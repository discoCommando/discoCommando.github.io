...
var _elm_lang$elm_architecture_tutorial$Types$zip = F2(
	function (l1, l2) {
		...
		if (((_p0.ctor === '_Tuple2') && (_p0._0.ctor === '::')) && (_p0._1.ctor === '::')) {
			return {
				...
				_1: A2(_elm_lang$elm_architecture_tutorial$Types$zip, _p0._0._1, _p0._1._1)
			};
		} else {
			return {ctor: '[]'};
		}
	});
var _elm_lang$elm_architecture_tutorial$Types$alreadyPassed = F2(
	function (accents, passed) {
		var passedWithZeros = A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$List$repeat,
				_elm_lang$core$List$length(accents) - _elm_lang$core$List$length(passed),
				0),
			passed);
		return A2(
			...
			_1: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'maybeCount',
						_1: A2(_elm_lang$elm_architecture_tutorial$Types$maybeEncode, _elm_lang$core$Json_Encode$int, record.maybeCount)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _elm_lang$elm_architecture_tutorial$Types$Block = F3(
	function (a, b, c) {
		return {tempo: a, accents: b, maybeCount: c};
	});
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$block = function () {
	...
	if (_p0.ctor === 'Ok') {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'ViewBlock',
			{
				...
				end: {line: 420, column: 26}
			},
			_p0)(_p0._0);
	}
}();
var _elm_lang$elm_architecture_tutorial$ViewBlock$zipOnlyLast = F2(
	function (accents, actual) {
		var _p2 = {ctor: '_Tuple2', _0: accents, _1: actual};
		if (_p2._0.ctor === '::') {
			if (_p2._1.ctor === '::') {
				if (_p2._1._1.ctor === '[]') {
					return {
						...
						_1: A2(
							_elm_lang$elm_architecture_tutorial$ViewBlock$zipOnlyLast,
							_p2._0._1,
							{ctor: '[]'})
					};
				} else {
					return {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p2._0._0, _1: _elm_lang$core$Maybe$Nothing},
						_1: A2(_elm_lang$elm_architecture_tutorial$ViewBlock$zipOnlyLast, _p2._0._1, _p2._1._1)
					};
				}
			} else {
				return {
			...
			if (_p2._1.ctor === '::') {
				return {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 0, _1: _elm_lang$core$Maybe$Nothing},
					_1: A2(
						_elm_lang$elm_architecture_tutorial$ViewBlock$zipOnlyLast,
						{ctor: '[]'},
						_p2._1._1)
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$maybeMapWithDefault = F3(
	function (maybe, f, $default) {
		var _p3 = maybe;
		if (_p3.ctor === 'Just') {
			return f(_p3._0);
		} else {
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$isJust = function (a) {
	var _p4 = a;
	if (_p4.ctor === 'Nothing') {
		return false;
	} else {
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$viewAccent = F3(
	function (animation, label, tempo) {
		var attributes = function () {
			...
			switch (_p5.ctor) {
				case 'Highlight':
					return {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('accent highlight'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'animation-duration',
										_1: A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(
												_elm_lang$core$Basics$floor(
													(60000 * _elm_lang$core$Time$millisecond) / _elm_lang$core$Basics$toFloat(tempo))),
											'ms')
									},
									_1: {ctor: '[]'}
								}),
				...
				case 'Glow':
					return {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('accent glow'),
						_1: {ctor: '[]'}
					};
				default:
					return {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('accent'),
						_1: {ctor: '[]'}
					};
			}
		}();
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$WorkingState = F3(
	function (a, b, c) {
		return {maybeCount: a, actual: b, highlightCount: c};
	});
var _elm_lang$elm_architecture_tutorial$ViewBlock$Temps = F2(
	function (a, b) {
		return {tempo: a, count: b};
	});
var _elm_lang$elm_architecture_tutorial$ViewBlock$Model = F3(
	function (a, b, c) {
		return {block: a, status: b, temps: c};
	});
var _elm_lang$elm_architecture_tutorial$ViewBlock$Finished = {ctor: 'Finished'};
var _elm_lang$elm_architecture_tutorial$ViewBlock$Paused = function (a) {
	return {ctor: 'Paused', _0: a};
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$Working = function (a) {
	return {ctor: 'Working', _0: a};
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$update = F2(
	function (msg, model) {
				...
				if (_p8.ctor === 'Tick') {
					return _Fresheyeball$elm_return$Return$singleton(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								status: _elm_lang$elm_architecture_tutorial$ViewBlock$Working(_p8._0)
							}));
				} else {
					return _Fresheyeball$elm_return$Return$singleton(model);
				}
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$init = _Fresheyeball$elm_return$Return$singleton(
	A3(
		_elm_lang$elm_architecture_tutorial$ViewBlock$Model,
		_elm_lang$elm_architecture_tutorial$ViewBlock$block,
		_elm_lang$elm_architecture_tutorial$ViewBlock$Working(
			{
				maybeCount: _elm_lang$core$Maybe$Just(5),
				actual: {
					ctor: '::',
					_0: 2,
					_1: {
		...
		{tempo: '160', count: '5'}));
var _elm_lang$elm_architecture_tutorial$ViewBlock$Idle = {ctor: 'Idle'};
var _elm_lang$elm_architecture_tutorial$ViewBlock$New = function (a) {
	return {ctor: 'New', _0: a};
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$RemoveAll = {ctor: 'RemoveAll'};
var _elm_lang$elm_architecture_tutorial$ViewBlock$ChangeCount = function (a) {
	return {ctor: 'ChangeCount', _0: a};
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$ClickCount = {ctor: 'ClickCount'};
var _elm_lang$elm_architecture_tutorial$ViewBlock$ChangeTempo = function (a) {
	return {ctor: 'ChangeTempo', _0: a};
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$Remove = function (a) {
	return {ctor: 'Remove', _0: a};
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$Add = function (a) {
	return {ctor: 'Add', _0: a};
};
var _elm_lang$elm_architecture_tutorial$ViewBlock$viewAddRemoveButtons = F2(
	function (minusDisabled, id) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('add-remove-buttons'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
					...
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_elm_lang$elm_architecture_tutorial$ViewBlock$Add(id)),
							_1: {ctor: '[]'}
						}
					},
					{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('remove-button'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$disabled(minusDisabled),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_elm_lang$elm_architecture_tutorial$ViewBlock$Remove(id)),
									_1: {ctor: '[]'}
								}
							}
						},
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$NoAnimation = {ctor: 'NoAnimation'};
var _elm_lang$elm_architecture_tutorial$ViewBlock$viewBlockIdle = F2(
	function (block, temps) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('block-info'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('tempo'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('tempo-info'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('tempo-value'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value(temps.tempo),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_elm_lang$elm_architecture_tutorial$ViewBlock$ChangeTempo),
															_1: {ctor: '[]'}
														}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(temps.tempo),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_0: _elm_lang$html$Html_Attributes$classList(
												{
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'count-info', _1: true},
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$ViewBlock$ClickCount),
												_1: {ctor: '[]'}
											}
										},
										{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('count-value'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
													...
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															...
															_0: _elm_lang$html$Html_Attributes$value(
																_elm_lang$elm_architecture_tutorial$ViewBlock$isJust(block.maybeCount) ? temps.count : '∞'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$disabled(
																	!_elm_lang$elm_architecture_tutorial$ViewBlock$isJust(block.maybeCount)),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onInput(_elm_lang$elm_architecture_tutorial$ViewBlock$ChangeCount),
																	_1: {ctor: '[]'}
																}
															}
														}
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$ViewBlock$RemoveAll),
														_1: {ctor: '[]'}
													}
												},
												{
							...
							function (i, accent) {
								return {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('accents'),
											_1: {ctor: '[]'}
										},
										A2(
											_elm_lang$core$Basics_ops['++'],
											A2(
												...
												function (index) {
													return A3(
														_elm_lang$elm_architecture_tutorial$ViewBlock$viewAccent,
														_elm_lang$elm_architecture_tutorial$ViewBlock$NoAnimation,
														_elm_lang$core$Basics$toString(index),
														block.tempo);
												},
												A2(_elm_lang$core$List$range, 1, accent)),
											{
												ctor: '::',
												_0: A2(_elm_lang$elm_architecture_tutorial$ViewBlock$viewAddRemoveButtons, false, i),
												_1: {ctor: '[]'}
											})),
									_1: {ctor: '[]'}
								};
						...
						block.accents)),
				{
					...
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$elm_architecture_tutorial$ViewBlock$viewAddRemoveButtons,
								true,
								_elm_lang$core$List$length(block.accents)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}));
	});
var _elm_lang$elm_architecture_tutorial$ViewBlock$viewBlockFinished = function (block) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
									...
									},
									{
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(block.tempo)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('count-info'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{
											...
											_0: _elm_lang$html$Html_Attributes$classList(
												{
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'count-value', _1: true},
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$style(
													{
														...
														_0: {
															...
															_1: A2(
																...
																_elm_lang$core$Basics$toString(
																	_elm_lang$core$Basics$floor(
																		(60000 * _elm_lang$core$Time$millisecond) / _elm_lang$core$Basics$toFloat(block.tempo))),
																'ms')
														},
														_1: {ctor: '[]'}
													}),
										...
										},
										{
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														A3(_elm_lang$elm_architecture_tutorial$ViewBlock$maybeMapWithDefault, block.maybeCount, _elm_lang$core$Basics$toString, '∞')),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$Glow = {ctor: 'Glow'};
var _elm_lang$elm_architecture_tutorial$ViewBlock$viewBlockPaused = F2(
	function (block, ws) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			{
												...
												_0: _elm_lang$html$Html_Attributes$classList(
													{
														...
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'animate bounce', _1: ws.highlightCount},
															_1: {ctor: '[]'}
														}
													}),
												_1: {
											...
											},
											{
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A3(_elm_lang$elm_architecture_tutorial$ViewBlock$maybeMapWithDefault, ws.maybeCount, _elm_lang$core$Basics$toString, '∞')),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
							...
							return {
								...
								_0: A2(
									...
									A2(
										...
										A2(_elm_lang$core$List$range, 1, _p13))),
								_1: {ctor: '[]'}
							};
						} else {
							var _p12 = _p11._0;
								...
								_0: A2(
									...
									A2(
										...
										A2(
											...
											A2(_elm_lang$core$List$range, 1, _p12 - 1)),
										A2(
											_elm_lang$core$Basics_ops['++'],
											{
												ctor: '::',
												_0: A3(
													_elm_lang$elm_architecture_tutorial$ViewBlock$viewAccent,
													_elm_lang$elm_architecture_tutorial$ViewBlock$Glow,
											...
											A2(
												...
												A2(_elm_lang$core$List$range, _p12 + 1, _p13))))),
								_1: {ctor: '[]'}
							};
						}
					},
					A2(_elm_lang$elm_architecture_tutorial$ViewBlock$zipOnlyLast, block.accents, ws.actual))));
	});
var _elm_lang$elm_architecture_tutorial$ViewBlock$Highlight = {ctor: 'Highlight'};
var _elm_lang$elm_architecture_tutorial$ViewBlock$viewBlockWorking = F2(
	function (block, ws) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			{
												...
												_0: _elm_lang$html$Html_Attributes$classList(
													{
														...
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'highlight-no-color', _1: ws.highlightCount},
															_1: {ctor: '[]'}
														}
													}),
												_1: {
								...
								_0: A2(
									...
									A2(
										...
										A2(
											...
											A2(_elm_lang$core$List$range, 1, _p17 - 1)),
										A2(
											_elm_lang$core$Basics_ops['++'],
											{
												ctor: '::',
												_0: A3(
													_elm_lang$elm_architecture_tutorial$ViewBlock$viewAccent,
													_elm_lang$elm_architecture_tutorial$ViewBlock$Highlight,
											...
											A2(
												...
												A2(_elm_lang$core$List$range, _p17 + 1, _p18))))),
								_1: {ctor: '[]'}
							};
						}
					},
...
var _elm_lang$elm_architecture_tutorial$ViewBlock$view = function (model) {
	...
	switch (_p19.ctor) {
		case 'Idle':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('block idle'),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$elm_architecture_tutorial$ViewBlock$viewBlockIdle, model.block, model.temps));
		case 'Working':
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('block working'),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$elm_architecture_tutorial$ViewBlock$viewBlockWorking, model.block, _p19._0));
		case 'Paused':
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('block paused'),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$elm_architecture_tutorial$ViewBlock$viewBlockPaused, model.block, _p19._0));
		default:
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('block finished'),
					_1: {ctor: '[]'}
				},
				_elm_lang$elm_architecture_tutorial$ViewBlock$viewBlockFinished(model.block));
	}
};
...
var _elm_lang$elm_architecture_tutorial$Metronome$WorkingState = F5(
	function (a, b, c, d, e) {
		return {accents: a, maybeCount: b, actual: c, highlightCount: d, lastClick: e};
	});
var _elm_lang$elm_architecture_tutorial$Metronome$Model = F3(
	function (a, b, c) {
		return {block: a, status: b, temps: c};
	});
...
var _elm_lang$elm_architecture_tutorial$Metronome$wsFromIdle = function (block) {
	return {
		...
		lastClick: _elm_lang$elm_architecture_tutorial$Metronome$High
	};
};
var _elm_lang$elm_architecture_tutorial$Metronome$Finished = {ctor: 'Finished'};
var _elm_lang$elm_architecture_tutorial$Metronome$makeFinished = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{status: _elm_lang$elm_architecture_tutorial$Metronome$Finished});
};
var _elm_lang$elm_architecture_tutorial$Metronome$Paused = function (a) {
	return {ctor: 'Paused', _0: a};
};
	...
	switch (_p6.ctor) {
		case 'Idle':
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					status: _elm_lang$elm_architecture_tutorial$Metronome$Paused(
						_elm_lang$elm_architecture_tutorial$Metronome$wsFromIdle(model.block))
				});
		case 'Working':
			return _elm_lang$core$Native_Utils.update(
				model,
...
var _elm_lang$elm_architecture_tutorial$Metronome$init = _Fresheyeball$elm_return$Return$singleton(
	A3(
		_elm_lang$elm_architecture_tutorial$Metronome$Model,
		_elm_lang$elm_architecture_tutorial$Metronome$block,
		_elm_lang$elm_architecture_tutorial$Metronome$Idle,
		{
			tempo: _elm_lang$core$Basics$toString(_elm_lang$elm_architecture_tutorial$Metronome$block),
			count: '5'
		}));
var _elm_lang$elm_architecture_tutorial$Metronome$emptyModel = {
	block: {
		tempo: 120,
		accents: {ctor: '[]'},
		maybeCount: _elm_lang$core$Maybe$Nothing
	},
	status: _elm_lang$elm_architecture_tutorial$Metronome$Idle,
	temps: {tempo: '120', count: '1'}
};
var _elm_lang$elm_architecture_tutorial$Metronome$Working = function (a) {
	return {ctor: 'Working', _0: a};
};
								...
								case 'Add':
									var addToBlock = F2(
										function (block, i) {
											return (_elm_lang$core$Native_Utils.cmp(
												i,
												_elm_lang$core$List$length(block.accents)) > 0) ? block : (_elm_lang$core$Native_Utils.eq(
												i,
												_elm_lang$core$List$length(block.accents)) ? _elm_lang$core$Native_Utils.update(
												block,
												{
													accents: A2(
														_elm_lang$core$Basics_ops['++'],
												...
												block,
												{
													accents: A2(
														...
														F2(
															function (index, a) {
																return _elm_lang$core$Native_Utils.eq(index, i) ? (a + 1) : a;
															}),
														block.accents)
												}));
										});
								...
								case 'Remove':
									var removeFromBlock = F2(
										function (block, i) {
											return (_elm_lang$core$Native_Utils.cmp(
												i,
												_elm_lang$core$List$length(block.accents)) > -1) ? block : _elm_lang$core$Native_Utils.update(
												block,
												{
													accents: _elm_lang$core$List$concat(
														A2(
															_elm_lang$core$List$indexedMap,
															F2(
																function (index, a) {
																	return _elm_lang$core$Native_Utils.eq(index, i) ? (_elm_lang$core$Native_Utils.eq(a, 1) ? {ctor: '[]'} : {
																		ctor: '::',
																		_0: a - 1,
																		_1: {ctor: '[]'}
																	}) : {
										...
										_elm_lang$core$Native_Utils.update(
											model,
											{
												block: _elm_lang$core$Native_Utils.update(
													block,
													{
														maybeCount: updateMaybeCount(block.maybeCount)
													})
											}));
								case 'ChangeTempo':
									var _p17 = _p9._0._0;
...
var _elm_lang$elm_architecture_tutorial$Metronome$ViewMsg = function (a) {
	...
	return A2(
		...
		function () {
			...
			switch (_p31.ctor) {
				...
				default:
					return _elm_lang$elm_architecture_tutorial$ViewBlock$view(
						{status: _elm_lang$elm_architecture_tutorial$ViewBlock$Finished, block: model.block, temps: model.temps});
			}
		}());
};
var _elm_lang$elm_architecture_tutorial$Metronome$Stop = {ctor: 'Stop'};
var _elm_lang$elm_architecture_tutorial$Metronome$Pause = {ctor: 'Pause'};
var _elm_lang$elm_architecture_tutorial$Metronome$Start = {ctor: 'Start'};
var _elm_lang$elm_architecture_tutorial$Metronome$viewTest = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				_1: {
						...
						_elm_lang$html$Html$button,
						{
							...
							_0: function () {
								...
								switch (_p32.ctor) {
									...
									case 'Working':
										return _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Metronome$Pause);
									case 'Paused':
										return _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Metronome$Start);
									default:
										return _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Metronome$Start);
						...
						},
						{
							...
							_0: function () {
								...
								switch (_p33.ctor) {
									...
									case 'Working':
										return _elm_lang$html$Html$text('Pause');
									case 'Paused':
										return _elm_lang$html$Html$text('Resume');
									default:
										return _elm_lang$html$Html$text('Start');
								}
							}(),
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$elm_architecture_tutorial$Metronome$view(model),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _elm_lang$elm_architecture_tutorial$Metronomes$at = F2(
	function (i, list) {
		at:
		while (true) {
			var _p7 = list;
...
var _elm_lang$elm_architecture_tutorial$Metronomes$atWs = F2(
	function (i, m) {
		return (_elm_lang$core$Native_Utils.cmp(
			i,
			_elm_lang$core$List$length(m.previous)) < 0) ? A2(_elm_lang$elm_architecture_tutorial$Metronomes$at, i, m.previous) : (_elm_lang$core$Native_Utils.eq(
			i,
			_elm_lang$core$List$length(m.previous)) ? _elm_lang$core$Maybe$Just(m.actual) : A2(
			_elm_lang$elm_architecture_tutorial$Metronomes$at,
...
var _elm_lang$elm_architecture_tutorial$Metronomes$insertWs = F3(
	function (i, a, m) {
		return (_elm_lang$core$Native_Utils.cmp(
			i,
			_elm_lang$core$List$length(m.previous)) < 0) ? _elm_lang$core$Native_Utils.update(
			m,
			{
				previous: A3(_elm_lang$elm_architecture_tutorial$Metronomes$insert, i, a, m.previous)
			}) : (_elm_lang$core$Native_Utils.eq(
			i,
			_elm_lang$core$List$length(m.previous)) ? _elm_lang$core$Native_Utils.update(
			m,
			{actual: a}) : _elm_lang$core$Native_Utils.update(
			m,
			{
				next: A3(
					_elm_lang$elm_architecture_tutorial$Metronomes$insert,
					(i - 1) - _elm_lang$core$List$length(m.previous),
					a,
					m.next)
			}));
...
var _elm_lang$elm_architecture_tutorial$Metronomes$ChangeTrack = function (a) {
	return {ctor: 'ChangeTrack', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Metronomes$Focus = {ctor: 'Focus'};
var _elm_lang$elm_architecture_tutorial$Metronomes$AddBlock = function (a) {
	return {ctor: 'AddBlock', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Metronomes$TickMsg = function (a) {
...
var _elm_lang$elm_architecture_tutorial$Metronomes$Pause = {ctor: 'Pause'};
var _elm_lang$elm_architecture_tutorial$Metronomes$Start = {ctor: 'Start'};
var _elm_lang$elm_architecture_tutorial$Metronomes$MetronomeMsg = F2(
	function (a, b) {
		return {ctor: 'MetronomeMsg', _0: a, _1: b};
	});
						...
						case 'Next':
							...
							if (_p31.ctor === '[]') {
								...
								return A2(
									_Fresheyeball$elm_return$Return$andThen,
									function (m) {
										return A2(_elm_lang$elm_architecture_tutorial$Metronomes$update, _elm_lang$elm_architecture_tutorial$Metronomes$Next, m);
									},
									A2(
										_Fresheyeball$elm_return$Return$map,
										function (changedMetronomeModel) {
...
var _elm_lang$elm_architecture_tutorial$Metronomes$viewMetronomes = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'metronomes', _1: true},
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
								...
								function (index, metronome) {
									return {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('add-block-button'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$button,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_elm_lang$elm_architecture_tutorial$Metronomes$AddBlock(index)),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_elm_lang$elm_architecture_tutorial$Metronomes$AddBlock(
												_elm_lang$core$List$length(model.metronomes))),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
				...
				return A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('past'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$indexedMap,
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('actual'),
									_1: {
										ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$Metronomes$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Intelligent Metronome'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('stop-button'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('control-button'),
												_1: {ctor: '[]'}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Metronomes$Next),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('next-button'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('control-button'),
													_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$elm_architecture_tutorial$Metronomes$viewMetronomes(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('All code for Intelligent Metronome is open source. '),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('https://github.com/discoCommando/intelligentMetronome'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(' — © 2017 discoCommando'),
											_1: {ctor: '[]'}
										}
									}
								}),
...
if (typeof _elm_lang$elm_architecture_tutorial$Metronomes$main !== 'undefined') {
    _elm_lang$elm_architecture_tutorial$Metronomes$main(Elm['Metronomes'], 'Metronomes', undefined);
}
